    ...
    <section id="portfolio-details" class="portfolio-details">
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-12">
                    <form action="article-servlet" method="post">
                ...
                <div class="col-sm-12">
                    ...
                    <%
                        Object articleInsertErrorObj = request.getAttribute("ArticleInsertError");
                        if( articleInsertErrorObj != null){
                            String articleInsertErrorMessage = "" + articleInsertErrorObj;
                    %>

                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Hata!</strong> <%=articleInsertErrorMessage %>
                    ...
                    <table class="table table-hover">
                        ...
                        <c:if test="${ dbUtil.authorArticles( aid ).size() == 0 }">
                            <tr>Haber Yok</tr>
                        </c:if>

                        <c:if test="${ dbUtil.authorArticles(aid).size() > 0 }">
                            <c:forEach items="${dbUtil.authorArticles(aid)}" var="item">
                                <tr>
                                    <th scope="row"><c:out value="${item.articleID}"></c:out></th>
                                    <td><c:out value="${item.category}"></c:out></td>
                                    <td><c:out value="${item.title}"></c:out></td>
                                    <td><a href="article-update-servlet?articleID=${item.articleID}" class="btn btn-warning btn-sm">Düzenle</a></td>
                                    <td><a href="article-servlet?articleID=${item.articleID}" class="btn btn-danger btn-sm" onclick=" return show_alert()">Sil</a></td>
                                </tr>
                            </c:forEach>
                        </c:if>
